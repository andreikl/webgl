...
WebGlApi.initWebGl = function (canvas) {
    try {
        ...
        WebGlApi.pMatrix = mat4.create();
        mat4.identity(WebGlApi.pMatrix);

        WebGlApi.vMatrix = mat4.create();
        mat4.identity(WebGlApi.vMatrix);

        WebGlApi.nMatrix = mat3.create();
        mat3.identity(WebGlApi.nMatrix);
...
WebGlApi.getShader = function(id) {
...
WebGlApi.OrbitControl = function (element, radius, minRadius, maxRadius) {
    ...
    this.update = function () {
        ...
        if (this.rotateAngleY < Math.PI / 2 && this.rotateAngleY > -Math.PI / 2) {
            mat4.lookAt([x, y, z], [0, 0, 0], [0, 1, 0], WebGlApi.vMatrix);
        } else {
            mat4.lookAt([x, y, z], [0, 0, 0], [0, -1, 0], WebGlApi.vMatrix);
        }

        mat4.toInverseMat3(WebGlApi.vMatrix, WebGlApi.nMatrix);
        mat3.transpose(WebGlApi.nMatrix);
    }
